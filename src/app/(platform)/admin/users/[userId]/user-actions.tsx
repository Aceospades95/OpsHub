      ...
      <FormDialog open={editOpen} onClose={() => setEditOpen(false)} title="Edit User" action={updateUser}>
        {({ fieldErrors }) => (
          <>
            ...
            <Select name="role" label="Role" defaultValue={user.role} options={[{label:"Viewer",value:"VIEWER"},{label:"Contributor",value:"CONTRIBUTOR"},{label:"Manager",value:"MANAGER"},{label:"Admin",value:"ADMIN"}]} />
