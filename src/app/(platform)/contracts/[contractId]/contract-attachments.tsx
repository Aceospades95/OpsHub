...
export function ContractAttachments({ contractId, links, embeds, canEdit, canDelete }: Props) {
    ...
    <div className="space-y-3">
      ...
      {canEdit && (
        <>
          ...
          <AddContentDialog open={open} onClose={() => setOpen(false)} entityType="contract" entityId={contractId} />
        </>
      )}
    </div>
  );
