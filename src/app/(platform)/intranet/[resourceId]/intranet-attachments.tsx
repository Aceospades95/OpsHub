...
export function IntranetAttachments({ resourceId, links, embeds, canEdit, canDelete }: Props) {
    ...
    <div className="space-y-3">
      ...
      {canEdit && (
        <>
          ...
          <AddContentDialog open={open} onClose={() => setOpen(false)} entityType="intranet" entityId={resourceId} />
        </>
      )}
    </div>
  );
