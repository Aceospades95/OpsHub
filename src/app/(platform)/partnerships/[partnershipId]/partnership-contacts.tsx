...
export function PartnershipContacts({ contacts, partnershipId, canEdit }: Props) {
  ...
  async function handleDelete(id: string) {
    ...
    fd.set("id", id);
    await deletePartnershipContact(null, fd);
    router.refresh();
  }
      ...
      {canEdit && (
        <>
          ...
          <FormDialog
            ...
            title="Add Contact"
            action={createPartnershipContact}
          >
            {({ fieldErrors }) => (
              <>
          ...
          {editContact && (
            <FormDialog
              ...
              title="Edit Contact"
              action={updatePartnershipContact}
            >
              {({ fieldErrors }) => (
                <>
