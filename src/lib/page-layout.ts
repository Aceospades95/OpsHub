...
export const PAGE_CARDS: Record<string, CardDefinition[]> = {
  dashboard: [
    ...
    { id: "my-tasks", label: "My Tasks", defaultGrid: { x: 0, y: 7, w: 6, h: 14, minW: 3, minH: 6 } },
    { id: "activity", label: "Recent Activity", defaultGrid: { x: 6, y: 7, w: 6, h: 14, minW: 3, minH: 6 } },
    { id: "projects-overview", label: "Active Projects", defaultGrid: { x: 0, y: 21, w: 6, h: 12, minW: 3, minH: 4 } },
    { id: "team-summary", label: "Team Overview", defaultGrid: { x: 6, y: 21, w: 6, h: 12, minW: 3, minH: 4 } },
  ],
  "client-detail": [
  ...
  "project-detail": [
    { id: "sub-projects", label: "Sub-Projects", defaultGrid: { x: 0, y: 0, w: 8, h: 9, minW: 4, minH: 4 } },
    { id: "team", label: "Team", defaultGrid: { x: 8, y: 0, w: 4, h: 9, minW: 3, minH: 4 } },
    ...
    { id: "contracts", label: "Contracts", defaultGrid: { x: 0, y: 28, w: 6, h: 9, minW: 3, minH: 4 } },
    { id: "attachments", label: "Attachments", defaultGrid: { x: 6, y: 28, w: 6, h: 9, minW: 3, minH: 4 } },
    { id: "comments", label: "Comments", defaultGrid: { x: 0, y: 37, w: 12, h: 10, minW: 4, minH: 4 } },
  ],
  "contract-detail": [
