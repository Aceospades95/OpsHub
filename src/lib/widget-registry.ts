...
export const GLOBAL_WIDGETS: WidgetDefinition[] = [
  ...
  // --- Productivity ---
  {
    ...
    icon: "Link",
    defaultGrid: { w: 4, h: 4, minW: 2, minH: 2 },
  },
  {
    id: "widget-calendar",
    label: "Calendar",
    ...
    category: "productivity",
    icon: "Calendar",
    defaultGrid: { w: 6, h: 6, minW: 4, minH: 4 },
  },
  {
    id: "widget-my-tasks",
    label: "My Tasks",
    ...
    category: "productivity",
    icon: "CheckSquare",
    defaultGrid: { w: 6, h: 6, minW: 3, minH: 3 },
  },
  {
  ...
  // --- Status & Monitoring ---
  {
    ...
    category: "status",
    icon: "Kanban",
    defaultGrid: { w: 12, h: 5, minW: 6, minH: 3 },
  },
  {
    ...
    category: "status",
    icon: "AlertTriangle",
    defaultGrid: { w: 6, h: 4, minW: 3, minH: 2 },
  },
  {
    id: "widget-countdown",
