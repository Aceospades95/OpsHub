...
export const DEFAULT_SEED_TEMPLATES: SeedTemplate[] = [
...

  {
    ...
    description:
      "Application → phone screen → technical interview → offer → conversion to onboarding. Triggers in Phase 4.",
    type: "CANDIDATE",
    ...
    steps: [
      ...
      {
        name: "Recruiter: initial resume review",
        stepType: "ASSIGN_TASK_TO_USER",
        config: {
          assignee: "owner",
          title: "Review {{subject.fullName}}'s resume",
          dueOffsetDays: 2,
        },
        timingType: "ON_ENTRY",
        timingValue: 0,
      ...
      {
        name: "Approve: move to phone screen?",
        stepType: "APPROVAL",
        config: {
          approver: "owner",
          prompt:
            "Move {{subject.fullName}} forward to a phone screen?",
        },
      ...
      },
      {
        ...
        stepType: "SCHEDULE_MEETING",
        config: {
          meetingTitle: "Phone screen with recruiter",
          attendees: ["subject", "owner"],
          durationMinutes: 30,
          offsetDays: 3,
        },
        timingType: "AFTER_STEP",
      ...
      {
        name: "Approve: move to technical interview?",
        stepType: "APPROVAL",
        config: {
          approver: "owner",
          prompt:
            "Did the phone screen go well enough to schedule a technical interview?",
        },
        timingType: "AFTER_STEP",
        timingValue: 0,
        isRequired: true,
      ...
      {
        name: "Approve: extend offer?",
        stepType: "APPROVAL",
        config: {
          approver: "owner",
          prompt: "Approve extending an offer to {{subject.fullName}}?",
        },
        timingType: "AFTER_STEP",
        timingValue: 0,
        isRequired: true,
      },
      {
        ...
        config: {
          documentText:
            "Replace this with your company's offer letter text — the candidate signs to accept.",
          required: true,
        },
        timingType: "AFTER_STEP",
        timingValue: 0,
